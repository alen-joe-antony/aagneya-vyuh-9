...
class GameController extends Controller
{
    ...
    function index($mode = 0) {
        $question_revealed_pre = UserLevel::findOrFail(Auth::user()->username)->question_revealed;
        if(!$question_revealed_pre) {
        ...
        if($current_level == env('NUM_LEVELS')) {
            return view('end');
        }
